...
function markerClickAdd(m, positions) {
    m.addListener('click', function () {
        ...
        document.getElementById('info').innerHTML =
            "<div id='placeIDbox' class=" + positions[mID].type + "><span id='placeID'>" + mID + "</span></div><H1>" + positions[mID].placeName + "</H1><span id='notStreetCloser' onclick='closeNotStreet()'>X</span><span id='date'>" +
...
function routeNext(nD) {
    ...
    if (positions[nextDisplay].type !== "route") {
        ...
        //document.getElementById('appNav').style.top='94px';
    }
    else {
...
function routePvs(pD) {
    ...
    if (positions[pvsDisplay].type !== "route") {
        ...
        //document.getElementById('appNav').style.top='75px';
    }
    else {
